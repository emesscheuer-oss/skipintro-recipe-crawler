## [0.5.17] - 2025-09-04
### Fixed
- NBSP/Thin NBSP werden vor dem Parsen in Leerzeichen gewandelt; Stopw�rter werden robust entfernt.
- Line-first-Fallback im Renderer extrahiert f�hrende Menge aus der vollst�ndigen Rohzeile (��, ca.�), wenn v3/v2 keine Menge liefern.
- Unicode-Fraktionen in Rohzeilen werden gemappt; Anzeige immer DE-Format mit Komma (max. 2 Nachkommastellen), keine Rohstrings.
- Einheiten-Schreibung konsolidiert (ml/g/kg/l klein; TL/EL gro�; St�ck korrekt), niemals �Ml�.
### Files
...
- Dev-Diagnostik-Badge (nur Dev-Mode) zeigt Pipeline f�r die ersten 5 Zutatenzeilen (raw/sanitized/prenorm/parsed/display + source).
- Refresh-Flow: Dev-Option �Force refresh� ignoriert Locks, parsed Felder werden �berschrieben; Feldquellen gespeichert und genutzt.
- Mojibake-Quelle entsch�rft: Sanitize-Reihenfolge auf Entities ? NFC ? Mojibake ? Whitespace umgestellt; �Stück� ? �St�ck� vor dem Parsen.
- DE-Einheiten und �ca.�/Stopw�rter konsolidiert; Unicode-Br�che am Zeilenanfang sicher erkannt und skaliert.
### Files
- includes/renderer.php
...
- Unicode-Brüche am Zeilenanfang (½, ⅓, ¼, ⅔, ¾) robust erkannt und in skalierbare Dezimalzahlen überführt.
- Text-Sanitisierung mit HTML-Entities, UTF-8/NFC und Mojibake-Fixes (z. B. „StÃ¼ck“ → „Stück“).
- Stopwörter „ca.“ u. a. (ca, circa, etwa, ungefähr, about, approx., (ca.), (ca)) entfernt.
- Einheitenschreibung in der Anzeige vereinheitlicht (ml, g, kg, l klein; TL/EL groß; Stück korrekt mit Umlaut).
### Files
- includes/parser.php
- includes/renderer.php
- skipintro-recipe-crawler.php
